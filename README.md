...
- Rename the base package `portfolio` to your preferred name. *[How to]*
...
```java
import portfolio.domain.executor.Executor;
import portfolio.domain.executor.MainThread;
import portfolio.domain.interactors.WelcomingInteractor;
import portfolio.domain.interactors.base.AbstractInteractor;
import portfolio.domain.repository.MessageRepository;
```
